...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260108115014_AddDocumentoIdentitaCliente'
)
BEGIN
    ALTER TABLE [Clienti] ADD [DocumentoDataRilascio] datetime2 NULL;
END;
...
BEGIN
    ALTER TABLE [Clienti] ADD [DocumentoNumero] nvarchar(50) NULL;
END;
...
BEGIN
    ALTER TABLE [Clienti] ADD [DocumentoRilasciatoDa] nvarchar(100) NULL;
END;
...
BEGIN
    ALTER TABLE [Clienti] ADD [DocumentoScadenza] datetime2 NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260108115014_AddDocumentoIdentitaCliente', N'9.0.0');
END;

IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260108165956_AddCampoClienteRifToAttivitaCampo'
)
BEGIN
